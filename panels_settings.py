"""Settings panel for Harness CCM Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__harness_ccm_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=harness_ccm_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_harness_ccm"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Harness CCM Settings & Accounts", level=2),
