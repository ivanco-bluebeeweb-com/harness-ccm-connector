"""Pydantic schemas for Harness CCM Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Harness CCM.")
    api_key: str = Field(description="FinOps API Key")
    base_url: str = Field(default="https://app.harness.io/gateway/ccm/api", description="Harness CCM API base URL.")
...
class GetCostRecordParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    costrecord_id: str = Field(description="Harness CCM CostRecord ID.")
