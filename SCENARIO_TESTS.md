# PST Testing Scenarios for Harness CCM Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_harness_ccm_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_harness_ccm_connector` without lingering secrets.
